...
const listItems = Fdata.map(dataf =>
  <div key={dataf.id} className="linkdata">
  <a href={dataf.href} rel='noreferrer' target='_blank'>
    <img src={dataf.url} alt={dataf.alt}/></a>
  </div> );
    ...
    <div className="Contacts">
      ...
      <div className="Contacts-1">
        <div className="Contacts-2">
          <iframe src="/speedtest/index.html" width="100%"height="100%" loading="lazy" frameBorder="0"/>
        </div>
        <div className="Contacts-2">
          ...
          <div className="Contacts-4">
            <iframe
              ...
              width="100%" height="100%" loading="lazy"title="Googld Map" frameBorder="0" />
          </div>
        </div>
      </div>
    </div>
